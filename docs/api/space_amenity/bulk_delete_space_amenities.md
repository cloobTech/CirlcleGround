# Bulk Delete Space Amenities

**Endpoint:** `DELETE /api/v1/space_amenities/`
**Description:** This endpoint allows user to delete  multiple space amenities from the database in a  request.
