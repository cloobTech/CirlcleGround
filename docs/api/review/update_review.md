...
**Description:** This endpoint allows an authenticated user with an ID that matches the reviewer ID on the review to update the review. The update window is only open for a specific period of time after which the user won't be able to update the review.
